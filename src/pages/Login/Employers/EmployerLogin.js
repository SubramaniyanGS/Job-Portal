...
return (
  <div className='employerlogin template d-flex justify-content-center align-items-center 100-w vh-100'>
      <div className='form_container pt-3 pb-3 ps-5 pe-5 rounded bg-white'>
      <form onSubmit={handleSubmit}>
          <h3 className='text-center companylog'>Company Login</h3>
          ...
          <p className='text-end mt-2'>
              Forget <a href=''>Password</a><Link to='/employersignup' className='ms-2'>Signup</Link>
          </p>
      </form>
      </div>
  </div>
